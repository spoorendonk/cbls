...
The C++ suite is **321 `TEST_CASE`s**: 317 registered by `catch_discover_tests`
plus the **4 `[timing]` cases registered by hand**. Of the 317, **6 carry the
...
- `ctest -LE slow` — the other 312 tests, ~8s with `-j`. This is what **pre-commit** runs.
