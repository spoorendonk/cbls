...
The C++ suite is **354 `TEST_CASE`s**: 350 registered by `catch_discover_tests`
...
- `ctest -LE slow` — the other 345 tests, ~9s with `-j`. This is what **pre-commit** runs.
...
5. the `.venv/bin/pytest` line in `README.md` for the Python side (300 tests, 81
