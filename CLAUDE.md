...
The C++ suite is **361 `TEST_CASE`s**: 357 registered by `catch_discover_tests`
plus the **4 `[timing]` cases registered by hand**. Of the 357, **6 carry the
...
- `ctest -LE slow` — the other 352 tests, ~9s with `-j`. This is what **pre-commit** runs.
...
5. the `.venv/bin/pytest` line in `README.md` for the Python side (429 tests, 81
