...
The C++ suite is **324 `TEST_CASE`s**: 320 registered by `catch_discover_tests`
plus the **4 `[timing]` cases registered by hand**. Of the 320, **6 carry the
...
- `ctest -LE slow` — the other 315 tests, ~8s with `-j`. This is what **pre-commit** runs.
