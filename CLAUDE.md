...
The C++ suite is **323 `TEST_CASE`s**: 319 registered by `catch_discover_tests`
plus the **4 `[timing]` cases registered by hand**. Of the 319, **6 carry the
...
- `ctest -LE slow` — the other 314 tests, ~8s with `-j`. This is what **pre-commit** runs.
