...
The C++ suite is **320 `TEST_CASE`s**: 316 registered by `catch_discover_tests`
plus the **4 `[timing]` cases registered by hand**. Of the 316, **6 carry the
...
- `ctest -LE slow` — the other 311 tests, ~8s with `-j`. This is what **pre-commit** runs.
