...
# reported a green summary while never executing any of the 147 binding tests — a
...
# same failure shape as the 147 binding tests, and gets the same answer: the skip
