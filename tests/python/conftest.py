...
# reported a green summary while never executing any of the 69 binding tests — a
...
# same failure shape as the 69 binding tests, and gets the same answer: the skip
