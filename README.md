...
cmake -B build
cmake --build build
ctest --test-dir build    # 475 C++ tests, ~25s (add -LE slow for the fast 466, ~12s)
```
...
cmake --build build
.venv/bin/pytest          # 798 tests, 164 of them for the bindings
```
